...
export async function askAssistant(
  ...
  const prompt = `You are a helpful personal finance assistant inside the Finora app. Answer the user's question using only the financial data below. Be concise and specific with numbers. If the data doesn't answer the question, say so.
